...
class printer_widget_about_text extends Widget_Base {
    ...
    public function get_name() {
        return 'printer-about-text';
    }

    public function get_title() {
        return esc_html__( 'About Text', 'printer' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'       =>  esc_html__( 'Title About Text', 'printer' ),
                'label_block'   =>  true
            ]
        );
        ...
        $this->start_controls_section(
            'section_text_editor',
            [
                'label' => esc_html__( 'Text Editor', 'printer' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   =>  esc_html__( 'Default description', 'printer' ),
            ]
        );
        ...
        $this->add_control(
            'align',
            [
                'label'     =>  esc_html__( 'Alignment Title', 'printer' ),
        ...
        $this->add_control(
            'text_editor_color',
            [
                'label'     =>  __( 'Text Editor Color', 'printer' ),
                'type'      =>  Controls_Manager::COLOR,
                'selectors' =>  [
        ...
        $this->add_control(
            'hide_line',
            [
                'label'     =>  esc_html__( 'Hide Line', 'printer' ),
                'type'      =>  Controls_Manager::SELECT,
                'default'   =>  'no',
                'options'   =>  [
                    'no'    =>  esc_html__( 'No', 'printer' ),
                    'yes'   =>  esc_html__( 'Yes', 'printer' ),
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'margin_bottom_line',
            [
                'label'     =>  esc_html__( 'Margin Bottom Line', 'printer' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new printer_widget_about_text );