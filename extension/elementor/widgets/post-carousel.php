...
class printer_widget_post_carousel extends Widget_Base {
    ...
    public function get_name() {
        return 'printer-post-carousel';
    }

    public function get_title() {
        return esc_html__( 'Posts Carousel', 'printer' );
    }
...
Plugin::instance()->widgets_manager->register_widget_type( new printer_widget_post_carousel );